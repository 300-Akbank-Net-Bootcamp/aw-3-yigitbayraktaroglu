    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EftTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EftTransactions_Account_AccountId",
                        column: x => x.AccountId,
                        principalSchema: "dbo",
                        principalTable: "Account",
                        principalColumn: "AccountNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountTransactions_ReferenceNumber",
                table: "AccountTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EftTransactions_AccountId",
                table: "EftTransactions",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_EftTransactions_ReferenceNumber",
                table: "EftTransactions",
                column: "ReferenceNumber");
        }
